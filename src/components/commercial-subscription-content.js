...
const commercialDetails = [
  ...
  'Sample data is available by email so that you may verify that the data is compatible with your systems. Please note that no support or software is provided.',
  'Usage of commercial directory data is valid for one year from the date of receipt and must be renewed or returned at the end of the term.',
