...
class CommercialSubscriptionContent extends Component {
  render() {
            ...
            <div className="col-lg-12 col-md-12">
              ...
              <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                ...
                <p>
                  ...
                  data we license is formatted as comma separated values,
                  suitable for importing into spreadsheets such as Lotus,
                  Microsoft Excel, or for using as merge data for Word Perfect
                  or Microsoft Word.
                </p>
                <p>
                ...
                >
                  <div className="d-flex flex-row justify-content-start align-items-center">
                    ...
                    <p className="pe-5 mt-4">
                      ...
                      The minimum order is $695, per directory area.
                    </p>
                  </div>
                  ...
                  <div className="d-flex flex-row justify-content-start align-items-center">
                    ...
                    <p className="pe-5 mt-4">
                      ...
                      subscribers as they are published for $995.
                    </p>
                  </div>
                  ...
                  <div className="d-flex flex-row justify-content-start align-items-center">
                    <i className="fas fa-long-arrow-alt-right pe-5 ps-5" />
                    <p className="pe-5 mt-4">
                      Special pricing is available to current subscribers of the
